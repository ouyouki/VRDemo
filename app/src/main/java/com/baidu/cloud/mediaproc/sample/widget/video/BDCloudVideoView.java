...
//            super.handleMessage(msg);
    ...
    private void initVideoView(Context context, AttributeSet attrs) {
        ...
        renderRootView.setBackgroundColor(Color.BLACK);
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.BDCloudVideoView, 0, 0);
            try {
                mbShowCacheInfo = a.getBoolean(R.styleable.BDCloudVideoView_showCacheInfo, true);
            } finally {
                a.recycle();
            }
        }
    ...
    private void openVideo() {
        ...
        try {
            ...
            mMediaPlayer.setOnMetadataListener(mMetadataListener);
...
//                    Log.d(TAG, "onBufferingUpdate: percent=" + percent);
                    ...
                    cachingProgressHint.setText(String.format("加载中，%d%%", percent));
    ...
    private IMediaPlayer.OnMetadataListener mMetadataListener = new IMediaPlayer.OnMetadataListener() {
        ...
        public void onMetadata(IMediaPlayer mp, Bundle meta) {
            if (mOnMetadataListener != null) {
                mOnMetadataListener.onMetadata(mp, meta);
            }
        }
    };
    ...
    public void setOnMetadataListener(IMediaPlayer.OnMetadataListener listener) {
        mOnMetadataListener = listener;
    }

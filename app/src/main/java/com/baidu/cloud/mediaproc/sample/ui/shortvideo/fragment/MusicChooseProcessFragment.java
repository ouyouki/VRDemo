...
public class MusicChooseProcessFragment extends Fragment {
                ...
                public List<Music> call() throws Exception {
                    ...
                    .subscribe(new Consumer<List<Music>>() {
                        ...
                        public void accept(@NonNull List<Music> musics) throws Exception {
                            MusicChooseProcessFragment.this.musics.addAll(musics);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_music_choose_process, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getParentFragment() instanceof View.OnClickListener) {
            binding.linearLayout.setOnClickListener((View.OnClickListener) getParentFragment());
        }

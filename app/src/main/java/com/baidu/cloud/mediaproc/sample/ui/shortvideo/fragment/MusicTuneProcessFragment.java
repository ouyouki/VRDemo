...
public class MusicTuneProcessFragment extends Fragment implements MediaPlayer.OnPreparedListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_music_tune_process, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getParentFragment() instanceof View.OnClickListener) {
            binding.cancel.setOnClickListener((View.OnClickListener) getParentFragment());
        }

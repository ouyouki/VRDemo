...
import com.baidu.cloud.mediastream.session.Constraints;
import com.baidu.cloud.mediastream.session.HandlerThreadSession;

import java.nio.ByteBuffer;

import static com.baidu.cloud.mediastream.session.Constraints.MSG_BGM_FINISHED;
...
public class AudioProcessSession  extends HandlerThreadSession {
     ...
     * @param bitrate
     */
    public AudioProcessSession(int sampleRateHz, int channelCount, int bitrate) {
